...
public class MaxVacationDaysWithDP {
            ...
            for(int week=0;week<weeks;week++){
                ...
                for(int currentCity=0;currentCity<cities;currentCity++){
                    for(int prevCity=0;prevCity<cities;prevCity++){
                        if(currentCity == prevCity || flights[prevCity][currentCity]==1){
                            temp[currentCity] = Math.max(temp[currentCity], dp[prevCity]+days[currentCity][week]);
        ...
        public static void main(String[] args){
            ...
            System.out.println(MaxVacationDaysWithDP.maxVacationDays(flights,days));
        }
